...
git clone --depth=2 --single-branch https://github.com/Redmi-MT6768/android_kernel_xiaomi_mt6768 kernel/xiaomi/mt6768
git clone --depth=1 --single-branch https://github.com/Redmi-MT6768/android_device_xiaomi_lava device/xiaomi/lava
...
git clone --depth=1 --single-branch https://github.com/Redmi-MT6768/android_vendor_xiaomi_lava vendor/xiaomi/lava
