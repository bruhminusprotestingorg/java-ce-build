...
git clone --depth=1 --single-branch https://github.com/Redmi-MT6768/android_kernel_xiaomi_mt6768 kernel/xiaomi/mt6768
git clone --depth=1 --single-branch https://github.com/Redmi-MT6768/android_device_xiaomi_merlinx device/xiaomi/merlinx
git clone --depth=1 --single-branch https://github.com/Redmi-MT6768/android_device_xiaomi_mt6768-common device/xiaomi/mt6768-common
git clone --depth=1 --single-branch https://github.com/Redmi-MT6768/android_vendor_xiaomi_merlinx vendor/xiaomi/merlinx
git clone --depth=1 --single-branch https://github.com/Redmi-MT6768/android_vendor_xiaomi_mt6768-ims vendor/xiaomi/mt6768-ims
git clone --depth=1 --single-branch https://github.com/CipherOS/android_device_mediatek_sepolicy_vndr.git device/mediatek/sepolicy_vndr
