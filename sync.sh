...
git clone --depth=1 --single-branch https://github.com/Redmi-MT6768/android_device_xiaomi_lava -b lineage-18.1 device/xiaomi/lava
...
git clone --depth=1 --single-branch https://github.com/Redmi-MT6768/android_vendor_xiaomi_lava -b eleven vendor/xiaomi/lava
